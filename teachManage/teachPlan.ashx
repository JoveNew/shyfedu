<%@ WebHandler Language="C#" Class="teachPlan" %>
...
public class teachPlan : IHttpHandler,IReadOnlySessionState {
    ...
    public string loadInfo(string submitData)
    {
        ...
        string sql = @"select plan_file,class_name,subject_name,account_name,year_name,subject_hour from data_plan t1 
                        ...
                        left join dict_year_info t5 on t2.year_code = t5.year_code
                        where plan_idx=@idx";
        SqlParameter[] paras = {
