<%@ WebHandler Language="C#" Class="scheduleTeacherTable" %>
using System;
using System.Web;
using System.Data;
using System.Data.SqlClient;

public class scheduleTeacherTable : IHttpHandler {
    ...
    public string loadTeacher(string submitData)
    {
        string code = submitData.Split(';')[1];
        string sql = @"select distinct teacher_idx,teacher_name from view_schedule_info where year_code=@code";
        SqlParameter[] paras = {
            new SqlParameter("@code", code)
        };
        DataTable dt = SQLServerDBHelp.doSql(sql,paras);
